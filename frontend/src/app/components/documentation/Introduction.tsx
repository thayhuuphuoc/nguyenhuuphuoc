...
export const Introduction = () => {
  ...
  const PackageVersions = [
    ...
    },
    {
      id: "5",
      packageName: "Sanity",
      img: "/images/documentation/Categories=Sanity.svg",
      version: "^3.92.0",
    },
  ];
  return (
    <>
      <div id="version" className="md:scroll-m-[130px] scroll-m-28">
        ...
        <div className="flex item-center justify-between">
          <h3 className=" text-black text-2xl mt-3 font-semibold mb-6 dark:text-white">
            Package Versions
          </h3>
        ...
        <div className="w-full flex justify-between lg:gap-0 gap-6 lg:flex-nowrap flex-wrap p-6 rounded-md border border-gray dark:border-white/20">
          {PackageVersions &&
            PackageVersions.map((item) => {
              return (
                <div
                  key={item.id}
                  className="lg:w-1/5 md:w-full text-center lg:border-b-0 border-b lg:border-e lg:last:border-e-0 last:border-b-0 border-gray dark:border-white/20"
                >
                  <Image
                    src={item.img}
                    alt="npm-package"

  ...
  return (
    <>
      ...
      <div className="p-6 rounded-md border mt-4 border-gray dark:border-white/20">
        <p className="text-base font-medium text-secondary dark:text-white flex lg:flex-row flex-col" >1. Change Logo over here : <span className="font-semibold text-base overflow-x-auto">src/app/components/layout/logo/index.tsx</span></p>
        <div className="py-4 px-3 rounded-md bg-black mt-8">
          ...
          <div className="text-sm">
            ...
            <p className="ms-3 text-white/70">width={135}</p>
            <p className="ms-3 text-white/70">height={35}</p>
            <p className="ms-3 text-white/70">quality={100}</p>
            ...
            <p className="ms-5 text-white/70">width={135}</p>
            <p className="ms-5 text-white/70">height={35}</p>
            <p className="ms-5 text-white/70">quality={100}</p>

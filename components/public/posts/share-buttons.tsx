...
import { Facebook, Twitter, Instagram, Share2, Copy, Check } from "lucide-react"

// Pinterest icon component (lucide-react doesn't have Pinterest)
...
export default function ShareButtons({ title, slug, description, image }: ShareButtonsProps) {
	...
	const handleShare = (platform: string) => {
		...
		switch (platform) {
			...
			case "twitter":
				...
				break
			case "instagram":
				// Instagram không hỗ trợ direct sharing qua URL, mở Instagram app hoặc website
